const mockData = {
  ...
  document4: {
    title: 'Number Four',
    content: `Passages of Lorem Ipsum available, but the majority have suffered 
    ...
    the Lorem Ipsum generators on the Internet tend to repeat predefined chunks
  ...
  document5: {
    title: 'Number Five',
    content: `Paaking this the first true generator on the Internet. It uses
    a dictionary of over 200 Latin words, combined with a handful of model 
    sentence structures, to generate Lorem Ipsum which looks reasonable.
    The generated Lorem Ipsum is therefore always free from repetition,
    injected humour, or non-characteristic words etc.`,
  ...
  incompleteDocument: {
    ...
    of over 200 Latin words, combined with a handful of model sentence struct,

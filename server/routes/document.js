...
module.exports = (app) => {
  ...
  app.get('/api/v1/documents/:id', Authorisation.checkToken, Documents.retrieveOne);
  app.put('/api/v1/documents/:id', Authorisation.checkToken, Documents.update);
  app.delete('/api/v1/documents/:id', Authorisation.checkToken, Documents.delete);
  app.get('/api/v1/users/:id/documents', Authorisation.checkToken, Documents.getMine);
  app.get('/api/v1/search/documents', Authorisation.checkToken, Documents.search);
};
